-- Migration 0011b: Recreate views cascade-dropped during migration 0011
-- Source: 0006_client_code_widen.sql lines 2751-8508
-- All statements use CREATE OR REPLACE VIEW (idempotent for existing views)
